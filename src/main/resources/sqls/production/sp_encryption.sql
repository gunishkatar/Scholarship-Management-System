...
BEGIN
   ...
   -- ENCRYPTION LOGIC TABLE CREATE
    DROP TABLE IF EXISTS `CSCI5308_7_PRODUCTION`.`encryption_logic`;

    CREATE TABLE IF NOT EXISTS `CSCI5308_7_PRODUCTION`.`encryption_logic`
    (
	...
	INSERT INTO `CSCI5308_7_PRODUCTION`.`encryption_logic`(`character`,`hash`) VALUES ('a','xt'),('b','rs'),('c','fd'),('d','cx'),
														 ('e','af'),('f','aa'),('g','xx'),('h','cv'),
														 ('i','bv'),('j','jh'),('k','jk'),('l','yt'),
														 ('m','rw'),('n','qa'),('o','qx'),('p','ut'),
														 ('q','bu'),('r','br'),('s','df'),('t','po'),
