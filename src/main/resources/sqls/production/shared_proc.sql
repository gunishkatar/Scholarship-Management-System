...
BEGIN
    ...
    DROP TABLE IF EXISTS `CSCI5308_7_PRODUCTION`.`user_credential`;
    CREATE TABLE IF NOT EXISTS `CSCI5308_7_PRODUCTION`.`user_credential`
    (
    ...
    DROP TABLE IF EXISTS `CSCI5308_7_PRODUCTION`.`feedback`;

    create table CSCI5308_7_PRODUCTION.feedback
    (
