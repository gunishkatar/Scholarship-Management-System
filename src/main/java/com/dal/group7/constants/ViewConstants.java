...
public class ViewConstants {
  ...
  public static final String SCHOLARSHIP_MANAGEMENT_SYSTEM =
          "WELCOME TO SCHOLARSHIP MANAGEMENT SYSTEM";
  public static final String SCHOLARSHIP_SCHEMES =
          "1. List Scholarship Schemes";
  public static final String SIGN_UP_AS = "Sign Up As : ";
  public static final String SIGNED_UP_AS_STUDENT =
          "Successfully signed up as student";
  public static final String SIGNED_UP_AS_INSTITUTE =
          "Successfully signed up as institute";
  ...
  public static final String VIEW_APPROVED_STUDENT_APPLICATIONS =
          "1. View Approved Student Applications";
  public static final String STUDENT_BANNED_MSG =
          "You have been banned from applying for Further Scholarships";
